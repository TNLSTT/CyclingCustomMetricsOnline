  ...
  try {
    ...
    return (
      <div className="space-y-10">
        <PageHeader
          title="Adaptation edges"
          description="Surface your deepest training blocks and understand how efficiency evolved across each block. Use these summaries to plan when to extend or reload your next progression."
        />
